    ...
    <div className={styles.container}>
      ...
      <nav className="w-full z-50 fixed inset-x-0 top-2 flex justify-center mt-0 items-center">
        <div className="w-full h-24 md:[100%] bg-navBar p-4 rounded-md flex items-center">
          <p className="text2xl md:text-4xl flex  text-slate-200 font-bold"><img objectFit='cover' layout="fill" className='w-6 md:w-9 h-6 md:h-9 bg-transparent' alt='logo' src="/chain.png"/>hainIDE|</p><span className=' text-slate-200  text-xl mr-5'>How To </span> 
      ...
      <main className="w-[90%] ml-auto mr-auto mt-7 relative md:mt-5">
        ...
        <div className='w-full h-72'></div>
        <div className="border border-zinc-800 rounded-md p-2 min-w-[300px] h-340 md:max-w-[90%] ml-auto mr-auto relative hover:border-zinc-600 duration-100 ease-in-out">
          <div className="w-full h-360 object-cover rounded-md my-4 relative" >
           <img src="/chain11.png" alt="chain" objectFit='cover' layout="fill" className="rounded-md my-4"/>
          </div>
        </div>
        <div className='w-full h-72'></div>
        </main>
